from heritagesites.models import CountryArea, DevStatus, HeritageSite, HeritageSiteCategory, HeritageSiteJurisdiction, Location, Planet, Region, SubRegion, IntermediateRegion
