...
class SiteUpdateView(generic.UpdateView):
	...
	def form_valid(self, form):
		...
		old_ids = HeritageSiteJurisdiction.objects.values_list('country_area_id', flat=True).filter(heritage_site_id=site.heritage_site_id)
		...
		for old_id in old_ids:
			if old_id in new_ids:
				...
				HeritageSiteJurisdiction.objects.filter(heritage_site_id=site.heritage_site_id, country_area_id=old_id).delete()
...
class SiteDeleteView(generic.DeleteView):
	...
	def delete(self, request, *args, **kwargs):
		...
		HeritageSiteJurisdiction.objects.filter(heritage_site_id=self.object.heritage_site_id).delete()
